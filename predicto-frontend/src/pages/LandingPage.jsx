        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="mailto:omarelsaber0@gmail.com" className="flex items-center gap-2 text-sm text-slate-400 hover:text-indigo-400 transition-colors">
                ✉ omarelsaber0@gmail.com
              </a>
              <a href="https://linkedin.com/in/omarelsaber" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-slate-400 hover:text-indigo-400 transition-colors">
                in linkedin.com/in/omarelsaber
              </a>
              <a href="https://github.com/omarelsaber" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-slate-400 hover:text-indigo-400 transition-colors">
