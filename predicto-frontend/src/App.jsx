...
function App() {
        ...
        return (
          ...
          >
            <div className="xl:col-span-1 flex flex-col gap-8">
              <div className="bg-[#0f172a] border border-gray-800 p-6 rounded-xl shadow-[0_0_15px_rgba(59,130,246,0.05)] transition-all hover:border-gray-700">
                <h2 className="text-lg font-semibold text-white mb-5 flex items-center gap-2">
                  <span className="w-1.5 h-5 bg-brand-primary rounded-full inline-block"></span>
                  AI Analyst
                </h2>
                <form onSubmit={handleAsk} className="flex flex-col gap-4">
                  <textarea 
                    className="w-full bg-[#1e293b]/40 border border-gray-700 rounded-lg p-3 text-sm text-gray-200 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-brand-primary focus:border-brand-primary transition-all resize-none shadow-inner custom-scrollbar"
                    rows="4"
                  ...
                  <button 
                    type="submit" 
                    className="bg-brand-primary hover:bg-blue-600 active:bg-blue-700 text-white font-medium py-3.5 px-4 rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_0_15px_rgba(59,130,246,0.3)] hover:shadow-[0_0_20px_rgba(59,130,246,0.4)] flex items-center justify-center gap-2"
  ...
  return (
    <div className="flex h-screen bg-[#020617] font-sans text-gray-200 overflow-hidden">
      {isBooting && (
        <div className="fixed inset-0 z-50 bg-[#020617]/90 backdrop-blur-md flex flex-col items-center justify-center">
          <Loader2 className="w-12 h-12 text-brand-primary animate-spin mb-5" />
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden bg-[#020617]">
        ...
        <header className="px-4 sm:px-10 py-5 border-b border-gray-800/80 flex justify-between items-center bg-[#0f172a]/95 backdrop-blur-md shrink-0 z-20 shadow-sm gap-4">
          <div className="flex items-center gap-4 min-w-0">
            {health && (
              <div className="flex items-center gap-3 bg-[#1e293b]/50 border border-gray-700/50 px-4 py-2.5 rounded-full shadow-inner">
                ...
                <span className="text-[11px] text-gray-300 font-bold uppercase tracking-wider">{health.status}</span>
                <span className="text-gray-600 hidden sm:inline">|</span>
                <span className="text-[11px] text-gray-500 font-medium hidden sm:inline">Up {Math.round(health.uptime_seconds)}s</span>
          ...
          <div className="flex items-center gap-3 sm:gap-6 shrink-0">
            <button 
              ...
              className="hidden md:flex items-center gap-2 bg-brand-primary hover:bg-blue-600 active:bg-blue-700 disabled:opacity-40 disabled:pointer-events-none text-white text-sm font-semibold py-2 px-5 rounded-lg transition-all shadow-[0_0_15px_rgba(59,130,246,0.2)] hover:shadow-[0_0_20px_rgba(59,130,246,0.4)]"
            >
              <Download size={16} />
              Download Report
            </button>
            ...
            <button 
              type="button"
              className="p-2.5 text-gray-400 hover:text-white transition-colors bg-[#1e293b]/50 border border-gray-700/50 rounded-full shadow-sm hover:bg-[#1e293b]"
            ...
            <div className="flex items-center gap-3 cursor-pointer hover:bg-[#1e293b]/50 p-1.5 rounded-xl transition-colors">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-brand-primary to-emerald-500 flex items-center justify-center border-2 border-[#1e293b] shadow-sm">
                <User size={20} className="text-white" />
              </div>
              <div className="hidden sm:block pr-2">
                <p className="text-sm font-bold text-white leading-tight">Antigravity</p>
                <p className="text-[11px] text-gray-400 font-medium uppercase tracking-wider mt-0.5">Enterprise Admin</p>
              </div>
            </div>
          </div>
        </header>
