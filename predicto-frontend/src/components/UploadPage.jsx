    ...
    <div className="flex items-center justify-center min-h-screen">
      <div className="w-full max-w-2xl mx-auto px-6">
        <header className="text-center mb-12">
          <h2 className="text-4xl font-bold text-white tracking-tight mb-3 flex items-center justify-center gap-3">
        ...
        <div className="space-y-6">
          <div
            ...
            className={`
              ...
              bg-slate-900/30 backdrop-blur-2xl border-white/10 shadow-2xl
              ${isDragging
                ? 'border-indigo-400/60 bg-indigo-500/10 shadow-[0_0_40px_rgba(59,130,246,0.25)]'
                : 'border-indigo-500/30 bg-indigo-500/5 hover:bg-indigo-500/10 hover:border-indigo-400/60'
              }
          ...
          <AnimatePresence>
            {error && (
              <motion.div
                ...
                className="mt-6 bg-rose-500/10 border border-rose-500/30 rounded-xl p-4 flex gap-3 items-start"
              >
        ...
        {/* Training Pipeline Status - Compact Glassmorphism Card */}
        {stage && (
          <div className="mt-12 w-full max-w-2xl mx-auto px-6">
            <div className="bg-slate-900/30 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 shadow-2xl">
              ...
              <div className="space-y-4">
                ...
                <div className="mb-6">
                  ...
                  <div className="w-full bg-gray-800/30 rounded-full h-3 overflow-hidden">
                    <motion.div
